...
import { sendEthFromAbstract } from "../helpers/ethers_helper";

interface Props {
    refreshWalletInfo: () => void
}

export function EthSender(props: Props) {
    ...
    async function createWallet() {
        if (walletAddress != '' && toAddress != '' && password != '')  {
            await sendEthFromAbstract(walletAddress, toAddress, password, amount)
